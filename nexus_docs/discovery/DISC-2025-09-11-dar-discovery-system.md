...
analysis_timestamp: 2025-09-11T21:18:32.299323
...
**Analysis Date:** 2025-09-11 21:18:32
**Target Path:** `/home/rmans/projects/Nexus`

## Executive Summary

This discovery analysis examined **98 files** totaling **460.8 KB** across **5 programming languages** (json, markdown, python, shell, yaml).
...
```json
{
  "metadata": {
    "target_path": "/home/rmans/projects/Nexus",
    "timestamp": "2025-09-11T21:18:32.299323",
    "version": "1.0.0",
    "options": {
      "cache": false,
      "deep": true
